  ...
  const experiences = [
    ...
    },
    {
      ...
      responsibilities: [
        ...
        "Migrated Claims, Members, Providers, and Vendors data for BHS, Freedom, Optimum, and Cencal health plans",
        "Built complete end-to-end Member Eligibility logic using SQL Server and SSIS",
        "Authored 1000+ lines of SQL to validate, transform, and load data with pre-checks, post-checks, mappings, and error handling",
        ...
        "Designed and implemented data auditing and lineage frameworks with acknowledgements and automated workflows",
