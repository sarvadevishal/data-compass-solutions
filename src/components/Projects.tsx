...
const Projects = () => {
  const projects = [
    ...
    {
      icon: Building2,
      title: "Healthcare Data Warehouse from Scratch",
      challenge: "Disparate systems, no unified reporting, 1TB+ historical data",
      solution: "Designed star-schema warehouse, built 50+ ETL jobs, implemented incremental loading",
      impact: "First-ever unified analytics platform, executive dashboards, compliance-ready audit trails",
      tech: ["Redshift", "Informatica Cloud", "Power BI", "Python"],
      color: "text-red-500",
